...
IDENTIFICATION_START_PROCESS_CLASS_NAME = "TrainingStartProcess"

def job(callback_code, **kwargs):
    IdentificationStartProcess.job(callback_code, **kwargs)


class IdentificationStartProcess(AlgorithmProcessInterface):
    def __init__(self, worker):
        AlgorithmProcessInterface.__init__(self, worker=worker)
        self._classname = IDENTIFICATION_START_PROCESS_CLASS_NAME
    ...
    @staticmethod
    def job(callback_code, **kwargs):
        IdentificationStartProcess._job_logger_info(IDENTIFICATION_START_PROCESS_CLASS_NAME, **kwargs)
