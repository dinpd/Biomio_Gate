...
def register_for_handshake(user_id, mails, extension_app_id, extension_pub_key, probe_app_id, probe_pub_key):
    ...
    store_keywords = {ApplicationDataStore.APP_TYPE_ATTR: extension_app_type,
    ...
    store_keywords = {ApplicationDataStore.APP_TYPE_ATTR: probe_app_type,
...
def main():
    register_for_handshake(user_id=1, mails=mails, extension_app_id=extension_app_id,
                           extension_pub_key=extension_pub_key,
